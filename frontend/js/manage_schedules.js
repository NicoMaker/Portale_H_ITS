        ...
        <table style="width:100%;border-collapse:collapse;">
          <thead>
            <tr style="background:linear-gradient(135deg,#f8f7ff,#f0f9ff);border-bottom:2px solid #e0e7ff;">
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">📚 Corso</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">🕐 Orario</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">📅 Giorno</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">📆 Data</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">👨‍🏫 Docente</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">🏫 Aula</th>
              <th style="padding:.75rem 1rem;text-align:left;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">📖 Materia</th>
              <th style="padding:.75rem 1rem;text-align:center;font-size:.75rem;font-weight:700;color:#4f46e5;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap;">⚙️ Azioni</th>
            </tr>
          </thead>
          <tbody>
    `;
      ...
      html += `
        <tr style="border-bottom:1px solid #f3f4f6;transition:background .15s;" onmouseover="this.style.background='#fafafa'" onmouseout="this.style.background=''">
          <td style="padding:.75rem 1rem;">
            <span style="display:inline-block;background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;padding:3px 10px;border-radius:9999px;font-size:.75rem;font-weight:600;">
              ${course ? course.name : "-"}
            </span>
          </td>
          <td style="padding:.75rem 1rem;">
          ...
          <td style="padding:.75rem 1rem;">
            <span style="background:#fefce8;color:#854d0e;padding:3px 8px;border-radius:6px;font-size:.75rem;font-family:monospace;font-weight:500;">${formatDate(s.date)}</span>
          </td>
          <td style="padding:.75rem 1rem;font-size:.875rem;font-weight:500;color:#111827;">${s.teacher || "-"}</td>
          <td style="padding:.75rem 1rem;">
            <code style="background:#f3f4f6;color:#374151;padding:2px 7px;border-radius:5px;font-size:.75rem;">${s.room || "-"}</code>
          </td>
